...
namespace Tangkoko\CustomerAttributesManagement\Block\Adminhtml\Customer\Attribute\Edit\Tab\Visibility;
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
     ...
     */
    protected function addTabToForm($attribute, $fieldsetId = 'conditions_fieldset', $formName = 'cam_customer_attributes_form')
    {
        ...
        $newChildUrl = $this->getUrl(
            'cam/customer/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $renderer->setTemplate(
            'Tangkoko_CustomerAttributesManagement::customer/visibility/conditions/fieldset.phtml'
        )->setNewChildUrl(
            $newChildUrl
        )->setFieldSetId(
