...
namespace Tangkoko\CustomerAttributesManagement\Block\Adminhtml\Address\Attribute\Edit\Tab\Required;
...
use Tangkoko\CustomerAttributesManagement\Block\Adminhtml\Address\Attribute\Edit\Tab\RequiredConditions;
    ...
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    protected function addTabToForm($attribute, $fieldsetId = 'requiredconditions_fieldset', $formName = 'cam_customer_attributes_form')
    {
        ...
        $newChildUrl = $this->getUrl(
            'cam/address/newRequiredConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $renderer->setTemplate(
            'Tangkoko_CustomerAttributesManagement::address/required/conditions/fieldset.phtml'
        )->setNewChildUrl(
            $newChildUrl
        )->setFieldSetId(
