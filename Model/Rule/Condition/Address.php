...
class Address extends \Magento\Rule\Model\Condition\AbstractCondition
{
    ...
    public function loadAttributeOptions()
    {
        ...
        $attributeModels = $this->attributeRepository->getList(\Magento\Customer\Api\AddressMetadataInterface::ENTITY_TYPE_ADDRESS, $this->searchCriteriaBuilderFactory->create()->create());
        $this->attributes = [];
        $options = [];
